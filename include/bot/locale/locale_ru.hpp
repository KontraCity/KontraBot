...
namespace Bot
{
    ...
    public:
        ...
        virtual inline dpp::message help()
        {
            ...
            strings.statsDescription = u8"Показать статистику этого сервера: количество отправленных команд, нажатых кнопок, проведённых сессий, проигранных треков и прочее.";
            ...
            strings.playFaq = {
                ...
                u8"*Однако, к сожалению, я пока не умею проигрывать стримы и премьеры.*\n"
        ...
        virtual inline dpp::message stats(const Stats& stats)
        {
            ...
            strings.sessionsConducted = u8"Сессий проведено";
