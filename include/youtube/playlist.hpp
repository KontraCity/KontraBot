...
namespace Youtube
{
    ...
    public:
        ...
        public:
            ...
            /// @brief Get current video playlist watch URL
            /// @throw std::invalid_argument if iterator is invalid
            /// @return Video playlist watch URL
    ...
    private:
        ...
        /// @param browseResponseJson API "browse" response JSON
        ...
        /// @param playlistHeaderRendererObject JSON playlist header renderer object
        ...
        /// @param videoCountObject JSON video count object
